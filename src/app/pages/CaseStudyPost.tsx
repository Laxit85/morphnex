...
export function CaseStudyPost() {
  ...
  // Find related studies (up to 3, excluding the current one)
  ...
  return (
    <div className="bg-[#0F0F0F] min-h-screen text-[#FFFFFF]">
      <SEO 
        title={`${study.title} | Morphnex Case Studies`} 
      ...
      <section className="relative pt-32 pb-16 overflow-hidden border-b border-[rgba(255,255,255,0.08)]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-10">
          ...
          >
            ...
            {/* Tags */}
            <div className="flex flex-wrap gap-2 pt-6 border-t border-[rgba(255,255,255,0.08)]">
              {study.tags.map((tag, idx) => (
                <span
                  key={idx}
                  className="bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] text-[#A0A0A0] text-[10px] uppercase font-bold tracking-widest px-3 py-1"
                >
                  {tag}
                </span>
              ))}
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#1A1A1A] border border-[rgba(255,255,255,0.08)] p-8 md:p-10 mb-16 max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-[#FFFFFF] mb-6 uppercase tracking-tight pb-4 border-b border-[rgba(255,255,255,0.08)]">
              Project <span className="text-[#C9A96E]">Summary</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="font-bold text-[#FFFFFF] uppercase tracking-widest text-xs mb-2">The Challenge</h3>
                <p className="text-[#A0A0A0] text-sm leading-relaxed font-medium">{study.challenge}</p>
              </div>
              <div>
                <h3 className="font-bold text-[#FFFFFF] uppercase tracking-widest text-xs mb-2">The Solution</h3>
                <p className="text-[#A0A0A0] text-sm leading-relaxed font-medium">{study.solution}</p>
              </div>
            </div>
            <div>
              <h3 className="font-bold text-[#FFFFFF] uppercase tracking-widest text-xs mb-4 flex items-center">
                <ShieldCheck className="w-4 h-4 mr-2 text-[#C9A96E]" />
                Key Outcomes & Results
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {study.results.map((result, idx) => (
                  <div key={idx} className="bg-black/30 border border-[#C9A96E]/20 p-4 text-center">
                    <p className="text-[#C9A96E] text-base font-black uppercase tracking-tight leading-snug">{result}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-24 bg-[#121212] border-t border-[rgba(255,255,255,0.08)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-black text-[#FFFFFF] mb-12 tracking-tighter uppercase text-center md:text-left">
              Related <span className="text-[#C9A96E]">Success Stories</span>
            </h2>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-[#A0A0A0] font-medium mb-12 max-w-2xl mx-auto relative z-10">
              Let's discuss how we can partner to build your next-generation digital products.
            </p>
            <Link
              to="/contact"
